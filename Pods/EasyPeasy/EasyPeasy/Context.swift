...
// SOFTWARE.
    ...
    public struct Context {
        ...
        init(with traitCollection: UITraitCollection) {
            ...
            isHorizontalCompact = traitCollection.horizontalSizeClass == .compact
            isVerticalCompact = traitCollection.verticalSizeClass == .compact
            isHorizontalVerticalCompact = traitCollection.horizontalSizeClass == .compact && traitCollection.verticalSizeClass == .compact

            // Regular size classes
            isVerticalRegular = traitCollection.verticalSizeClass == .regular
            isHorizontalRegular = traitCollection.horizontalSizeClass == .regular
            isHorizontalVerticalRegular = traitCollection.horizontalSizeClass == .regular && traitCollection.verticalSizeClass == .regular
        }
    }
